...
@section('content')
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-sky-50 via-white to-indigo-50">
        <div class="w-full mx-auto text-center hero-animate">
            <h1 class="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Products & Solutions</h1>
            ...
            <div class="mb-20">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="order-1 md:order-2">
                        ...
                        <a href="https://demo.pradytecai.com" target="_blank" class="inline-block bg-sky-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-sky-700 transition">
                            View Demo →
                        </a>
                    </div>
                </div>
