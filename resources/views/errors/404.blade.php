...
@section('content')
    <section class="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-[80vh] flex items-center">
        ...
        <div class="section-content w-full mx-auto text-center max-w-2xl">
            <div class="mb-8">
                <h1 class="text-9xl font-bold text-[var(--prady-blue)] mb-4">404</h1>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
                ...
                <div class="grid md:grid-cols-3 gap-4 text-sm">
                    <a href="/products" class="text-[var(--prady-blue)] hover:underline">Products</a>
                    <a href="/services" class="text-[var(--prady-blue)] hover:underline">Services</a>
                    <a href="/about" class="text-[var(--prady-blue)] hover:underline">About Us</a>
                    <a href="/blog" class="text-[var(--prady-blue)] hover:underline">Blog</a>
                    <a href="/careers" class="text-[var(--prady-blue)] hover:underline">Careers</a>
                    <a href="/contact" class="text-[var(--prady-blue)] hover:underline">Contact</a>
                </div>
            </div>
        </div>
    </section>
