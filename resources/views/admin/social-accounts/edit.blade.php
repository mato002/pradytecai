...
<div class="flex gap-3"><button class="btn-primary">Save</button><a href="{{ route('admin.social-accounts.show', $account) }}" class="btn-ghost" data-admin-modal-close data-turbo-frame="admin_main">Cancel</a></div>
</form></div>
@endsection
